      ...
      <form class="form-inline" role="form" id="user-shop-comment-<?php echo $shop['id']; ?>">
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="hidden" name="category_comment_subid"
                   value="<?php echo $next_category_comment_subid; ?>" />
            <input type="hidden" name="shopitem_id" value="<?php echo $shop['id']; ?>" />
            <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id']; ?>" />
          </div>
        </div>
        <button type="submit" class="btn btn-default">Submit</button>
        <div id="added-ok-<?php echo $shop['id']; ?>" class="text-success" hidden>
          <h3>Successfully added comment! Boom...</h3>
        </div>
        <div id="add-failed-<?php echo $shop['id']; ?>" class="text-danger" hidden>
