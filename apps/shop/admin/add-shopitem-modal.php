<div class="container-fluid">
  <div class="row text-center">
    ...
    <button type="button" class="btn btn-primary" id="shop-btn" data-toggle="modal"
            data-target="#shop-form">
      Open Form
    </button>
  </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div id="added-ok" class="text-success" hidden>
            <h3>Successfully added shop item! Boom...</h3>
          </div>
          <div id="add-failed" class="text-danger" hidden>
            <h3>Failed to add shop item!</h3>
          </div>
        </div>
