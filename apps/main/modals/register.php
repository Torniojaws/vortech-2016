      ...
      <div class="modal-body">
        <div class="container-fluid">
          <div class="row">
            ...
            <form class="form" id="register-form" name="register-form">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="registerUsername"
                       name="registerUsername" placeholder="Name">

                <!-- Password -->
                <label for="registerPassword">Password</label>
                <p class="text-warning">
                  Please use a password that you don't use elsewhere, just to be safe. While
                  security is taken care of to a good standard, this just a simple login for
            ...
            <div id="register-ok" class="text-success" hidden>
              Successfully registered! Enjoy...
            </div>
            <div id="register-failed" class="text-danger" hidden>
