<div class="container-fluid">
  <div class="row text-center">
    ...
    <button type="button" class="btn btn-primary" id="video-btn" data-toggle="modal"
            data-target="#video-form">Open Form</button>
  </div>
          ...
          <form class="form" id="ad-video-form" name="add-video-form"
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="url" name="url"
                     placeholder="http://www.videosite.com/video/123" />
            ...
            <button type="submit" class="btn btn-primary" name="Submit" id="send-video-form">
              Add the video
            </button>
          </form>
          <div id="added-ok" class="text-success" hidden>
            <h3>Successfully added video! Boom...</h3>
          </div>
          <div id="add-failed" class="text-danger" hidden>
            <h3>Failed to add video!</h3>
          </div>
        </div>
