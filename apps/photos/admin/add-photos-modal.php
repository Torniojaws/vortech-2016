<div class="container-fluid">
  <div class="row text-center">
    ...
    <button type="button" class="btn btn-primary" id="photo-btn" data-toggle="modal"
            data-target="#photo-form">
      Open Form
    </button>
  </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div id="added-ok" class="text-success" hidden>
            <h3>Successfully added photos! Boom...</h3>
          </div>
          <div id="add-failed" class="text-danger" hidden>
            <h3>Failed to add photos!</h3>
          </div>
        </div>
