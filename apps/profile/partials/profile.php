<div class="container-fluid">
  ...
  <div class="row">
    ...
    <p>Feel free to update your information below. Press the "Save Changes" button below,
    ...
    <form class="form" id="profile-form" name="profile-form">
      <div class="form-group">
        <div class="col-sm-6">
          ...
          <input type="hidden" class="form-control" id="profileOldUsername"
                 name="profileOldUsername" value="<?php echo $user['username']; ?>">
          ...
          <input type="text" class="form-control" id="profileCaption" name="profileCaption"
                 placeholder="Short personal text (max 60 chars)"
                 value="<?php echo $user['caption']; ?>">
        </div>
      </div>
      <div class="form-group">
        <div class="col-sm-6">
          ...
          <input type="password" class="form-control" id="profileOldPassword"
                 name="profileOldPassword" placeholder="Current password">
          <input type="password" class="form-control" id="profileNewPassword1"
                 name="profileNewPassword1" placeholder="New password">
          <input type="password" class="form-control" id="profileNewPassword2"
                 name="profileNewPassword2" placeholder="New password again">
          <br />
