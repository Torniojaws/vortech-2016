<div class="container-fluid">
    <div class="row text-center">
        ...
        <button type="button" class="btn btn-primary" id="liveshow-btn" data-toggle="modal" data-target="#liveshow-form">Open Form</button>
    </div>
                ...
                <div class="modal-body">
                    ...
                    <form class="form" id="ad-liveshow-form" name="add-liveshow-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="continent" name="continent" placeholder="eg. Europe" />
                            <label for="date">Country</label>
                            <input type="text" class="form-control" id="country" name="country" placeholder="eg. Finland" />
                            <label for="date">City</label>
                            <input type="text" class="form-control" id="city" name="city" placeholder="eg. Helsinki" />
                            <label for="date">Venue</label>
                            <input type="text" class="form-control" id="venue" name="venue" placeholder="eg. Tavastia" />
                        </div>
                        <!-- Additional details -->
                        ...
                        <div class="form-group" id="show-extra-details">
                            ...
                            <textarea class="form-control" rows="5" id="other_bands" name="other_bands" placeholder="Band|http://www.band.fi"></textarea>
                            <label for="date">Band comments</label>
                            <input type="text" class="form-control" id="band_comments" name="band_comments" placeholder="eg. It was a great show" />
                        ...
                        <button type="submit" class="btn btn-primary" name="Submit" id="send-liveshow-form">Add the show</button>
                    </form>
                    <div id="added-ok" class="text-success" hidden><h3>Successfully added show! Boom...</h3></div>
