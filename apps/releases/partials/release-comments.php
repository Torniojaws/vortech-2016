<aside class="well">
    ...
    <?php
        if ($_SESSION['user_logged'] == 1) { ?>
            ...
            <form class="form-inline" role="form" id="user-release-comment-<?php echo $release['release_code']; ?>">
                ...
                <div id="added-ok-<?php echo $release['release_code']; ?>" class="text-success" hidden><h3>Successfully added comment! Boom...</h3></div>
                <div id="add-failed-<?php echo $release['release_code']; ?>" class="text-danger" hidden><h3>Failed to add comment!</h3></div>
            </form>
            <br />
        <?php } else {
